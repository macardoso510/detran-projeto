          ...
          <div class="header-bottom">
            ...
            <div class="header-search">
              <div class="br-input has-icon">
                <label for="searchbox-33807">Texto da pesquisa</label>
                <input id="searchbox-33807" type="text" placeholder="O que você procura?"/>
      ...
      <header class="br-header">
        <div class="container-lg">
          ...
          <div class="header-bottom">
            ...
            <div class="header-search">
              <div class="br-input has-icon">
                <label for="searchbox-89160">Texto da pesquisa</label>
                <input id="searchbox-89160" type="text" placeholder="O que você procura?"/>
                <button class="br-button circle small" type="button" aria-label="Pesquisar"><i class="fas fa-search" aria-hidden="true"></i>
                </button>
              </div>
              <button class="br-button circle search-close ml-1" type="button" aria-label="Fechar Busca" data-dismiss="search"><i class="fas fa-times" aria-hidden="true"></i>
      ...
      <header class="br-header compact">
        <div class="container-lg">
          ...
          <div class="header-bottom">
            ...
            <div class="header-search">
              <div class="br-input has-icon">
                <label for="searchbox-52085">Texto da pesquisa</label>
                <input id="searchbox-52085" type="text" placeholder="O que você procura?"/>
                <button class="br-button circle small" type="button" aria-label="Pesquisar"><i class="fas fa-search" aria-hidden="true"></i>
                </button>
              </div>
              <button class="br-button circle search-close ml-1" type="button" aria-label="Fechar Busca" data-dismiss="search"><i class="fas fa-times" aria-hidden="true"></i>
      ...
      <header class="br-header small">
        <div class="container-lg">
          ...
          <div class="header-bottom">
            ...
            <div class="header-search">
              <div class="br-input has-icon">
                <label for="searchbox-51182">Texto da pesquisa</label>
                <input id="searchbox-51182" type="text" placeholder="O que você procura?"/>
                <button class="br-button circle small" type="button" aria-label="Pesquisar"><i class="fas fa-search" aria-hidden="true"></i>
                </button>
              </div>
              <button class="br-button circle search-close ml-1" type="button" aria-label="Fechar Busca" data-dismiss="search"><i class="fas fa-times" aria-hidden="true"></i>
      ...
      <header class="br-header large">
        <div class="container-lg">
          ...
          <div class="header-bottom">
            ...
            <div class="header-search">
              <div class="br-input has-icon">
                <label for="searchbox-37336">Texto da pesquisa</label>
                <input id="searchbox-37336" type="text" placeholder="O que você procura?"/>
                <button class="br-button circle small" type="button" aria-label="Pesquisar"><i class="fas fa-search" aria-hidden="true"></i>
                </button>
              </div>
              <button class="br-button circle search-close ml-1" type="button" aria-label="Fechar Busca" data-dismiss="search"><i class="fas fa-times" aria-hidden="true"></i>
