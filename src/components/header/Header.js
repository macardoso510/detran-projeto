                ...
                <div className="header-bottom">
                    <div className="header-menu">
                        <div className="header-menu-trigger">
                            <button onClick={() => console.log('teste')} className="br-button small circle" type="button" aria-label="Menu" data-toggle="menu" data-target="#main-navigation" id="navigation"><i className="fas fa-bars" aria-hidden="true"></i>
                            </button>
                        </div>
                    ...
                    <div className="header-search">
                        <div className="br-input has-icon">
                            <label for="searchbox-20735">Texto da pesquisa</label>
                            <input id="searchbox-20735" type="text" placeholder="O que você procura?" />
