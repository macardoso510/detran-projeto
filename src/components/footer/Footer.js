    ...
    return (
        ...
        <footer className="br-footer">
            <div className="container-lg">
                <div className="logo"><img src="https://cdngovbr-ds.estaleiro.serpro.gov.br/design-system/images/logo-negative.png" alt="Imagem" /></div>
                <div className="br-list horizontal" data-toggle="data-toggle" data-sub="data-sub">
                    ...
                    <div className="col-2"><a className="br-item header" href="javascript:void(0)">
                        ...
                        <div className="br-list"><span className="br-divider d-md-none"></span><a className="br-item" href="javascript:void(0)">
                            <div className="content">Duis incididunt consectetur</div></a><a className="br-item" href="javascript:void(0)">
                                ...
                                <div className="content">Duis incididunt consectetur</div></a><span className="br-divider d-md-none"></span>
                        </div>
                    </div>
                    <div className="col-2"><a className="br-item header" href="javascript:void(0)">
                    ...
                    <div className="col-2"><a className="br-item header" href="javascript:void(0)">
                        ...
                        <div className="br-list"><span className="br-divider d-md-none"></span><a className="br-item" href="javascript:void(0)">
                            <div className="content">Nulla occaecat eiusmod</div></a><a className="br-item" href="javascript:void(0)">
                                <div className="content">Qui esse</div></a><span className="br-divider d-md-none"></span>
                        </div>
                    </div>
                </div>
                <div className="d-none d-sm-block">
                    <div className="row align-items-end justify-content-between py-5">
                        ...
                        <div className="col assigns text-right"><img className="ml-4" src="https://cdngovbr-ds.estaleiro.serpro.gov.br/design-system/images/logo-assign-negative.png" alt="Imagem" /><img className="ml-4" src="https://cdngovbr-ds.estaleiro.serpro.gov.br/design-system/images/logo-assign-negative.png" alt="Imagem" />
                        </div>
                    </div>
                </div>
